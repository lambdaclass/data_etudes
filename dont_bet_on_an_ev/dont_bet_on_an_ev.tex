...
\begin{equation*}
  \begin{split}
      W_n &= w_0 * 1.5^{X_n + \mathbb{E}[X_n] - \mathbb{E}[X_n]} * 0.6^{n - X + \mathbb{E}[X_n] - \mathbb{E}[X_n]}\\
    &= w_0 *  1.5^{X_n - \mathbb{E}[X_n]}*1.5^{\mathbb{E}[X_n]} * 0.6^{- X + \mathbb{E}[X_n]} * 0.6^{n - \mathbb{E}[X_n]} \\
    & = w_0 *  1.5^{X_n - \mathbb{E}[X_n]} * 0.6^{- X_n + \mathbb{E}[X_n]} * 1.5^{\mathbb{E}[X_n]} * 0.6^{n - \mathbb{E}[X_n]}\\
    & = w_0 *  1.5^{X_n - \mathbb{E}[X_n]} * 0.6^{- (X_n - \mathbb{E}[X_n])} * 1.5^{\mathbb{E}[X_n]} * 0.6^{n - \mathbb{E}[X_n]}
  \end{split}
\end{equation*}
...
\begin{align}
  \begin{equation*}
    A_n = 1.5^{X_n - \mathbb{E}[X_n]} * 0.6^{-(X_n - \mathbb{E}[X_n])}
  \end{equation*}
\end{align}
...
Thanks to the Strong Law of Large Numbers we know that $\lim_{n\to\infty}{X_n - \mathbb{E}[X_n]} = 0$ almost sure (i.e. with probability equal to 1).
