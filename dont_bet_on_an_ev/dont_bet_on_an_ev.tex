...
\\\\
As $n$ grows, the number of winning $X$ and losing rounds will converge almost surely to $1/2$. As $n$ grows, the possible outcomes of $W_n$ start to concentrate around an only value with probability equal to $1$.
